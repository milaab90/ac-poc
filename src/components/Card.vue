<template>
    <div class="flex flex-col justify-center items-center mb-10">
      ...
      >
        ...
        <div v-if="hover" class="absolute bg-opacity-25 bottom-0 border h-full rounded-lg w-full" :style="{ backgroundColor: card['bubble-color'], height: '210px', opacity: '0.95' }">
      ...
      <button @click="selectCard(card)" class="bg-blue font-bold mt-5 px-8 py-2 rounded-lg text-beige text-lg text-center uppercase">Select</button>
    </div>
